                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="hb-menu">
                                    <nav>
                                        <ul>
                                            <li class="dropdown-holder"><a href="">Principales</a>
                                                <ul class="hb-dropdown">
                                                    <li class="active"><a href="{{URL."producto/index"}}">Productos</a></li>
                                                    <li><a href="{{URL."categoria/index"}}">Categorias</a></li>
                                                    <li><a href="{{URL."marca/index"}}">Marcas</a></li>
                                                </ul>
                                            </li>
                                            <li class="dropdown-holder"><a href="">Usuarios</a>
                                                <ul class="hb-dropdown">
